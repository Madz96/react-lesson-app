...
import PosterDetails from '../../components/postManager/PosterDetails';
      ...
      <div>
         ...
         <div>
            {posters.map((poster) => (
               <div key={poster.id}>
                  ...
                  <button onClick={() => onDeletePoster(poster.id)}>
                     Delete
                  </button>
                  <button onClick={() => handleShowDetailsModal(poster)}>
                     View Details
                  </button>
               </div>
            ))}
         ...
         <Modal show={showModal} onHide={handleCloseModal}>
            <Modal.Header closeButton>
               <Modal.Title>
                  {selectedPoster ? 'Edit Poster' : 'Add Poster'}
               </Modal.Title>
            </Modal.Header>
            <Modal.Body>
